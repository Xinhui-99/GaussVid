...
class WanVideoPipeline(BasePipeline):
    ...
    def __call__(
        ...
        depth_start_end: Optional[Image.Image] = None,
        # Animate
        ...
        inputs_shared = {
            ...
            "end_image": end_image, "vace_camera": vace_camera, "depth_start_end":depth_start_end,
            "input_video": input_video, "denoising_strength": denoising_strength, "animate_pose_video": animate_pose_video,
...
class WanVideoUnit_VACE(PipelineUnit):
    ...
    def process(
        ...
        vace_video, vace_video_mask, vace_camera, animate_pose_video,vace_reference_image, vace_scale,
        height, width, num_frames,
        tiled, tile_size, tile_stride
    ):
        
        control_camera_latents_input=None
        if vace_camera is not None and animate_pose_video is not None:
...
def model_fn_wan_video(
    ...
    **kwargs,
    ...
    # Camera control
    x = dit.patchify(x, control_camera_latents_input=None, depth_latents_input=depth_latents_input) #control_camera_latents_input=None
