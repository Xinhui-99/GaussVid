...
local_vap_model_path = "/mnt/dongxu-fs2/data-ssd/xinhuiliu/demo/1New3DGS/Octree-GS-VideoDif/DiffSynth-Studio/examples/wanvideo/model_inference/models/Video-As-Prompt-Wan2.1-14B"

# 获取所有 transformer safetensors 文件
transformer_files = sorted(glob.glob(f"{local_vap_model_path}/transformer/diffusion_pytorch_model-*.safetensors"))
print(f"Found transformer files: {transformer_files}")
...
pipe = WanVideoPipeline.from_pretrained(
    ...
    model_configs=[
        ...
        ModelConfig(model_id="/mnt/dongxu-fs2/data-ssd/xinhuiliu/demo/1New3DGS/Octree-GS-VideoDif/DiffSynth-Studio/examples/wanvideo/model_inference/Wan-AI/Wan2.1-I2V-14B-720P", origin_file_pattern="models_t5_umt5-xxl-enc-bf16.pth", **vram_config),
        ModelConfig(model_id="/mnt/dongxu-fs2/data-ssd/xinhuiliu/demo/1New3DGS/Octree-GS-VideoDif/DiffSynth-Studio/examples/wanvideo/model_inference/Wan-AI/Wan2.1-I2V-14B-720P", origin_file_pattern="Wan2.1_VAE.pth", **vram_config),
        ModelConfig(model_id="/mnt/dongxu-fs2/data-ssd/xinhuiliu/demo/1New3DGS/Octree-GS-VideoDif/DiffSynth-Studio/examples/wanvideo/model_inference/Wan-AI/Wan2.1-I2V-14B-720P", origin_file_pattern="models_clip_open-clip-xlm-roberta-large-vit-huge-14.pth", **vram_config),
    ],
    tokenizer_config=ModelConfig(model_id="/mnt/dongxu-fs2/data-ssd/xinhuiliu/demo/1New3DGS/Octree-GS-VideoDif/DiffSynth-Studio/examples/wanvideo/model_inference/Wan-AI/Wan2.1-T2V-1.3B", origin_file_pattern="google/umt5-xxl/"),
    vram_limit=torch.cuda.mem_get_info("cuda:0")[1] / (1024 ** 3) - 2,
)
